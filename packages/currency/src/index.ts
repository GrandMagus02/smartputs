 ...
 *
 * Three doors. `.` is this one — the table and the vocabulary a kind is built
 * out of. `./validate` is the engine-free parser and formatter. `./class` is
...
export { currencyVocabulary } from "./lexicon";
export type {
  AmountError,
  AmountFailure,
  AmountOptions,
