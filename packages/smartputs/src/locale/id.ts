// Generated facade over `@smartput/core/locale/id` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/id";
export { default, indonesian } from "@smartput/core/locale/id";
