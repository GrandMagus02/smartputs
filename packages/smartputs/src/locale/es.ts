// Generated facade over `@smartput/core/locale/es` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/es";
export { default, spanish } from "@smartput/core/locale/es";
