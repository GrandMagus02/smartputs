// Generated facade over `@smartput/core/locale/de` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/de";
export { default, german } from "@smartput/core/locale/de";
