// Generated facade over `@smartput/core/locale/ru` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/ru";
export { default, russian } from "@smartput/core/locale/ru";
