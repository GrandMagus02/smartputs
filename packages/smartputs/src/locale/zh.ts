// Generated facade over `@smartput/core/locale/zh` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/zh";
export {
  chinese,
  default,
} from "@smartput/core/locale/zh";
