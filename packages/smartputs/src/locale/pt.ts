// Generated facade over `@smartput/core/locale/pt` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/pt";
export { default, portuguese } from "@smartput/core/locale/pt";
