// Generated facade over `@smartput/core/locale/it` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/it";
export { default, italian } from "@smartput/core/locale/it";
