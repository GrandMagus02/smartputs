// Generated facade over `@smartput/core/locale/ko` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/ko";
export { default, korean } from "@smartput/core/locale/ko";
