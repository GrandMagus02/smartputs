// Generated facade over `@smartput/core/locale/ar` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/ar";
export {
  arabic,
  default,
} from "@smartput/core/locale/ar";
