// Generated facade over `@smartput/core/locale/fr` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/fr";
export { default, french } from "@smartput/core/locale/fr";
