// Generated facade over `@smartput/core/locale/nl` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/nl";
export { default, dutch } from "@smartput/core/locale/nl";
