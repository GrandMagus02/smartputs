// Generated facade over `@smartput/core/locale/ja` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/ja";
export { default, japanese } from "@smartput/core/locale/ja";
