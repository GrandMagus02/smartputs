// Generated facade over `@smartput/core/locale/pl` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/pl";
export { default, polish } from "@smartput/core/locale/pl";
