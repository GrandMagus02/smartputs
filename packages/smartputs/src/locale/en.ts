// Generated facade over `@smartput/core/locale/en` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/en";
export { default, english } from "@smartput/core/locale/en";
