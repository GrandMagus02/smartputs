// Generated facade over `@smartput/core/locale/uk` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/uk";
export { default, ukrainian } from "@smartput/core/locale/uk";
