// Generated facade over `@smartput/core/locale/tr` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/tr";
export { default, turkish } from "@smartput/core/locale/tr";
