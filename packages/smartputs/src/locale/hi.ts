// Generated facade over `@smartput/core/locale/hi` — see `packages/smartputs/README.md` for why
...
export type * from "@smartput/core/locale/hi";
export { default, hindi } from "@smartput/core/locale/hi";
